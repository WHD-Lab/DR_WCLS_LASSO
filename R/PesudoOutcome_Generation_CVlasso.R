# Generate Pseudo-outcome DR-WCLS version
...
#' This function uses CV LASSO to conduct model training on folds then estimates \eqn{E[Y_{t+1}|H_t, A_t], E[A_t|H_t], E[A_t|S_t]} for the reserved fold. Then
